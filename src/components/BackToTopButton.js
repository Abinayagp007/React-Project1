...
const BackToTopButton = () => {
  ...
  return (
    <>
      {showButton && (
        <IconButton varient="contained" baseClassName="fas" className="fa-plus-circle" onClick={handleScrollToTop} style={{ position: 'fixed', bottom: '20px', right: '10vh', color:"lightgrey",  }}>
          {/* <ArrowUpward /> */}
          <ArrowCircleUpTwoToneIcon style={{fontSize:'3.5rem'}}/>
        </IconButton>
      )}
    </>
  );
